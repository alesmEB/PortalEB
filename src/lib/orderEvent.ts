...
export const orderEventTypeLabel: Record<OrderEventType, string> = {
  ...
  [OrderEventType.ORDER_TASKS_UPDATED]: 'Modificó los trabajos a realizar',
  ...
  [OrderEventType.ORDER_ADJUST_REVERTED]: 'Revirtió el ajuste de la orden',
  [OrderEventType.SERVICE_PROTOCOL_REVERTED]: 'Revirtió el protocolo de servicio',
  [OrderEventType.ORDER_INVOICE_REVERTED]: 'Revirtió la facturación de la orden',
  [OrderEventType.EXTERNAL_CODE_UPDATED]: 'Actualizó el número del gestor interno',
  [OrderEventType.ORDER_DELETED]: 'Eliminó la orden',
  [OrderEventType.ORDER_FORCE_COMPLETED]: 'Completó la orden directamente',
}
