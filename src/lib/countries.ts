// Full ISO 3166-1 country list (Spanish common names + alpha-2 code), used to
// populate the EB Engineering country dropdown and to compute flag emoji
// programmatically (see countryFlag.ts) instead of hand-maintaining one emoji
// per country, which is how Croatia ended up missing/showing a blank flag.
export const COUNTRIES: { code: string; name: string }[] = [
  ...
  { code: 'CG', name: 'República Democrática del Congo' },
